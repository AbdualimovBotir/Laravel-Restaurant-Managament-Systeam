...
<section id="testimonial" class="bg-[url(assets/images/testimonial-bg.jpg')] bg-center bg-cover bg-no-repeat mt-28 px-10 py-24 relative w-full z-1">
    ...
    <div class="m-4 max-w-md mt-5 p-4 text-center text-white mx-auto">
        <h3 class="font-bold font-cursive-merie text-4xl leading-normal capitalize">Mijozlar <span class="text-amber-400 leading-snug">fikrlari</span> . . .</h3>
        <p class="pt-2 text-[14px] font-sans-lato text-slate-100 leading-relaxed">Bizning restaranimiz haqida mijozlarimiz nimalar deganini bilmoqchimisiz? </p>
        quyida mijozlarimizning fikrlari.
    </div>
...
<!-- Fikrlar Maydoni Tugaydi -->
<?php /**PATH C:\Users\Admin\PhpstormProjects\restaurant-site-laravel\resources\views/home/partials/testimonial.blade.php ENDPATH**/ ?>