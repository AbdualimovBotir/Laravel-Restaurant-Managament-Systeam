    ...
    <div class="flex flex-wrap footer-widget justify-between p-3 py-14 max-w-[960px] mx-auto section-padding">
        <div class="basis-[300px] grow shrink p-5 pr-9 single-widget single-widget1">
            ...
            <p class="mt-3 leading-normal">
                Oshxonamiz haqida ma'lumotlar
            </p>
        </div>
        <div class="single-widget single-widget2 leading-loose p-5 pr-7">
            <h5 class="mb-2 font-bold font-cursive-merie text-lg capitalize text-amber-400">biz bilan bog'laning</h5>
            <div class="flex items-start">
                <i class="fa fa-map-marker pr-3 pl-1 pt-2.5"></i>
                <p>
                    1234 Ba'zi Ko'cha, Jizzax Sh.Rashidov, <br />
                    Uzb
                </p>
            </div>
            <div class="flex">
            ...
            <div class="flex">
                ...
                <p>botirabdualimov7@gmail.com</p>
            </div>
        </div>
        <div class="single-widget single-widget3 leading-loose p-5 justify-self-end">
            <h5 class="mb-2 font-bold font-cursive-merie text-lg capitalize text-amber-400">ish vaqtlari</h5>
            <p>Dushanba ...................... Yopiq</p>
            <p>Seshanba-Juma .............. 10:00 - 12:00</p>
            <p>Shanba-Yakshanba ............... 08:00 - 23:00</p>
            <p>Bayramlar ............. 10:00 - 12:00</p>
        </div>
    </div>
    <div class="footer-copyright py-3 text-white bg-slate-900">
        <div class="flex flex-wrap items-center max-w-[960px] mx-auto px-3 justify-between">
            <span class="my-3 mx-5 leading-normal">
                ...
                <a class="text-cyan-400" href="https://github.com/AbdualimovBotir/" target="_blank">Botir Abdualimov</a> | Dizayn
            </span>
            <ul class="social-icons flex flex-wrap my-3 mx-5 transition ease-in-out duration-300">
                <li class="mr-4 my-1">Bizni kuzatib boring:</li>
...
<!-- Footer Area End -->
<?php /**PATH C:\Users\Admin\PhpstormProjects\restaurant-site-laravel\resources\views/home/partials/footer.blade.php ENDPATH**/ ?>