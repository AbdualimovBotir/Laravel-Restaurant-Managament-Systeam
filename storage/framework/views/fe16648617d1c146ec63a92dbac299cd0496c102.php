...
<section class="py-32 mx-auto max-w-[960px]">
    <div class="m-4 max-w-md mt-5 mb-11 p-4 text-center mx-auto">
        <h3 class="font-bold font-cursive-merie text-4xl leading-normal capitalize">Bizning <span class="text-amber-400 leading-snug">maxsus</span> taomlarimiz</h3>
        <p class="pt-2 text-[14px] font-sans-lato text-slate-600 leading-relaxed">Odamlar uchun judayam maqul keladi</p>
    </div>
        ...
        <div class="p-3 flex flex-wrap items-center justify-around<?php echo e($loop->first ? " mt-0": " mt-10"); ?><?php echo e($loop->iteration % 2 == 0 ? " flex-row-reverse" : ""); ?>">
            <div class="p-5 basis-[400px] grow shrink max-w-[650px]<?php echo e($loop->iteration % 2 == 0 ? " pr-7" : ""); ?>">
                ...
                <div class="<?php echo e($loop->iteration % 2 == 0 ? "text-right" : ""); ?>">
                    ...
                    <p class="mt-4 font-bold font-cursive-merie text-2xl text-amber-400 "><?php echo e($data['price']); ?> so'm</p>
                    <a href="#book">
                        <p class="mt-4 inline-block rounded-sm shadow px-3 py-3 uppercase font-sans-monts text-xs font-bold text-slate-900 transition ease-in-out duration-300 hover:-translate-y-1 hover:scale-110 hover:bg-transparent ">stolni bron qilish <span><i class="fa fa-long-arrow-right"></i></span></p>
                    </a>
                </div>
            </div>
...
<!-- Deshes Area End -->
<?php /**PATH C:\Users\Admin\PhpstormProjects\restaurant-site-laravel\resources\views/home/partials/deshes.blade.php ENDPATH**/ ?>