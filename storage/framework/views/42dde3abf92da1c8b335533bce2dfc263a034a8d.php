...
<?php $component->withAttributes([]); ?>
    <div class="content-wrapper">
        <a href="<?php echo e(route('foodmenu.create')); ?>" class="btn btn-primary mx-2">Yangi Ovqat Qo'shish</a>
    </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover overflow-auto block">
                        ...
                        <tr class="bg-slate-800">
                            <?php $__currentLoopData = ["Rasm", "Nomi", "Narxi", "Tavsifi", "Yaratilgan sana", "", ""]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $heading): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Admin\PhpstormProjects\restaurant-site-laravel\resources\views/admin/pages/foodmenu/foodmenu.blade.php ENDPATH**/ ?>